...
namespace BrightcoveVideoCloudIntegration.VideoPlayer
{
    ...
    public class VideoPlayer : VideoCloudWebPart
    {
        ...
        [HtmlDesignerAttribute(VideoPlayer.VideoChooser, DialogFeatures = "dialogHeight:410px;dialogWidth:430px;help:no;status:no;resizable:yes")]
        ...
        [HtmlDesignerAttribute(VideoPlayer.PlaylistChooser, DialogFeatures = "dialogHeight:400px;dialogWidth:400px;help:no;status:no;resizable:yes")]
        ...
        protected override void CreateChildControls()
        {
            ...
            VideoPlayerUserControl userControl = (VideoPlayerUserControl)Page.LoadControl(@"~/_CONTROLTEMPLATES/15/BrightcoveVideoCloudIntegration/BrightcoveVideoCloudPlayer/VideoPlayerUserControl.ascx");
            long vid = 0;
            ...
            if (playerId == null) {
                playerId = this.DefaultVideoPlayerId;
            }

            if (playlistId == null) {
                playlistId = this.DefaultPlaylistPlayerId;
            }
