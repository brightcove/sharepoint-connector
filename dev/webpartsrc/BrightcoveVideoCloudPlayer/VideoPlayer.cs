...
namespace BrightcoveVideoCloudIntegration.VideoPlayer
{
    ...
    public class VideoPlayer : VideoCloudWebPart
    {
        ...
        [HtmlDesignerAttribute(VideoPlayer.VideoChooser, DialogFeatures = "dialogHeight:430px;dialogWidth:430px;help:no;status:no;resizable:yes")]
        ...
        [HtmlDesignerAttribute(VideoPlayer.PlaylistChooser, DialogFeatures = "dialogHeight:430px;dialogWidth:400px;help:no;status:no;resizable:yes")]
